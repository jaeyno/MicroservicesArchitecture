...
namespace Discount.Grpc.Protos {
  public static partial class DiscountProtoService
  {
    ...
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.GetDiscountRequest> __Marshaller_GetDiscountRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.GetDiscountRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.CouponModel> __Marshaller_CouponModel = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.CouponModel.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.CreateDiscountRequest> __Marshaller_CreateDiscountRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.CreateDiscountRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.UpdateDiscountRequest> __Marshaller_UpdateDiscountRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.UpdateDiscountRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.DeleteDiscountRequest> __Marshaller_DeleteDiscountRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.DeleteDiscountRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Discount.Grpc.Protos.DeleteDiscountResponse> __Marshaller_DeleteDiscountResponse = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Discount.Grpc.Protos.DeleteDiscountResponse.Parser.ParseFrom);
